...
impl super::MachArch for x86_64 {
    const CPU_TYPE: Option<u32> = Some(0x01000007);
}
impl super::YaxInstruction for yaxpeax_x86::long_mode::Instruction {
    const GAP: i32 = -1;
...
impl crate::Instruction for yaxpeax_x86::long_mode::Instruction {
